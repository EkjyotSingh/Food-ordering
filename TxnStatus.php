<?php
	...
	if (isset($_POST["ORDER_ID"]) && $_POST["ORDER_ID"] != "") {
		...
		$requestParamList = array("MID" => constant('PAYTM_MERCHANT_MID') , "ORDERID" => $ORDER_ID);  
		
		$StatusCheckSum = getChecksumFromArray($requestParamList,constant('PAYTM_MERCHANT_KEY'));
